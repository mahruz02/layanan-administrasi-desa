...
<body>
    ...
    <div class="biodata">
        <center>
            <strong><u>SURAT PENGANTAR SKU</u></strong>
            <br>
            <p>Nomor : </p>
        </center>
        <p>
        ...
        <p>
            Sesuai dengan nama bersangkutan diatas, surat keterangan pengantar ini dibuat untuk keperluan {{$data->keperluan}} surat keterangan usaha (SKU).
        </p>
        <p>
